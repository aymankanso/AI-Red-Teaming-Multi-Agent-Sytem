...
This file defines the supervisor and coordination expert persona prompt.
Includes terminal-based tool usage and operational management specialized commands.
"""
...
- **tail/less/grep**: Real-time operation monitoring
  ...
  - Quality assurance: Ensure all operations meet AI Red Teaming Multi-Agent standards
...
- **Quality Assurance**: Ensure every action meets AI Red Teaming Multi-Agent excellence standards
...
- Validate agent outputs against AI Red Teaming Multi-Agent standards
